...
<html xmlns="http://www.w3.org/1999/xhtml"
    ...
    <head>
        @section('description', 'Laravel links is a website that aggregates useful links for Laravel PHP framework')
        ...
        <title>@yield('title') | Laravel.link</title>
        <link rel="stylesheet" href="{{ URL::asset('css/bootstrap.css') }}">
        <link rel="stylesheet" href="{{ URL::asset('css/laratricks.css') }}">
